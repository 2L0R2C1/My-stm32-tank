...
/* Private defines -----------------------------------------------------------*/
#define Bopan_IN1_Pin GPIO_PIN_0
#define Bopan_IN1_GPIO_Port GPIOA
#define Bopan_IN2_Pin GPIO_PIN_1
#define Bopan_IN2_GPIO_Port GPIOA
#define Friction1_Pin GPIO_PIN_6
#define Friction1_GPIO_Port GPIOA
#define Friction2_Pin GPIO_PIN_7
#define Friction2_GPIO_Port GPIOA
#define FrictionL_Pin GPIO_PIN_10
#define FrictionL_GPIO_Port GPIOB
#define FrictionR_Pin GPIO_PIN_11
