...
//	Bopan.target_speed = 0.5; Bopan.mode = 0;
	...
	HAL_UART_Receive_IT(&huart2,(uint8_t *)&receiver6,1);
...
//		HAL_UART_Transmit(&huart2,(uint8_t *)&receiver1,1,1);
		if(receiver1 == '1')	__HAL_TIM_SetCompare(&htim3,TIM_CHANNEL_1,150),__HAL_TIM_SetCompare(&htim3,TIM_CHANNEL_2,150),printf("1\r\n");
		if(receiver1 == '2')	__HAL_TIM_SetCompare(&htim3,TIM_CHANNEL_1,100),__HAL_TIM_SetCompare(&htim3,TIM_CHANNEL_2,100),printf("2\r\n");
		if(receiver1 == '4') 	scanf("%d",&pwm), printf("OK\r\n");
		HAL_UART_Receive_IT(&huart1,(uint8_t *)&receiver1,1);
	}
	if(huart->Instance == USART2){
//		HAL_UART_Transmit(&huart2,(uint8_t *)&receiver6,1,1);	
